...
func TestSplitURLs(t *testing.T) {
	in := "http://192.168.x.x:27141/subscription.txt,https://raw.githubusercontent.com/0xRadikal/Free-v2ray-Configs/main/top100.txt"
	got := splitURLs(in)
	if len(got) != 2 {
		t.Fatalf("expected 2 URLs, got %d: %v", len(got), got)
	}
	if got[0] != "http://192.168.x.x:27141/subscription.txt" {
